...
exports.updateSection = async (req, res) => {
  try {
    ...
    // console.log("updeted",updatedSection);
    // console.log("old",sectionID);
...
exports.deleteSection=async (req,res)=>{
    try{
      ...
      const updatedCourse=await Course.findByIdAndUpdate({_id:courseID},{$pull:{courseContent:sectionID}},{new:true}).populate({
        path: "courseContent",
        populate: {
          path: "subSection",
        },
